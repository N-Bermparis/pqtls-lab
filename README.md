...
report, benchmark, educational material, research project, or other
research-oriented work, please cite the project.
...
> Nikolaos Bermparis, *pqtls-lab: A Post-Quantum TLS 1.3 Research Laboratory*, 2026.

Repository: <https://github.com/N-Bermparis/pqtls-lab>

Please cite the released version you actually used, and state the OpenSSL
version and hardware alongside any figure or benchmark result derived from it.

### Use in research and industry

If pqtls-lab materially contributes to an academic publication, thesis,
research or European-funded project, cybersecurity or cryptographic evaluation,
commercial proof of concept, benchmark, experimental study, or derivative
research tool, please acknowledge **pqtls-lab** and **Nikolaos Bermparis** where
appropriate.

The maintainer would also greatly appreciate being notified when the project is
used in published research, funded projects, commercial evaluations, or
substantial derivative work. This helps document the research impact and
adoption of the project.

**Notification is appreciated but is not a condition of the Apache License 2.0.**
...
Development certificates generated by the scripts here are unencrypted test
material, are git-ignored, and must never be deployed.
